...
(function ($) {
    ...
    function Editor(options){
        ...
        var add_text_pane = function(id, text){
        ...
        var new_editor_helper = function(filename, text){
        ...
        function handle_new_file_input(e, text){
            ...
            new_editor_helper(filename, text);
        }

        var pop_up_new_file_modal = function(text){
        ...
        var new_editor = function(filename, text){
            var new_file_name=null;
            if(typeof filename === 'string')
                new_file_name = filename;
            if(new_file_name)
                return new_editor_helper(new_file_name, text || "");
            else {
                pop_up_new_file_modal(text || "");
            }
            return null;
        }
        ...
        /* Public methods */
        this.new_editor = function(name, text){
            return new_editor(name || null, text || "");
        }
